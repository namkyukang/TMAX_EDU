...
%>
 <table border=1 bordercolor="gray" cellspacing=1 cellpadding=0 width="100%">
   <tr bgcolor="gray">
  <td colspan=2 align="center"><font color="white"><b>Session Info</b></font></td></tr>
   <tr>
  <td width= "25%">SessionID</td><td width="75%"><%=sessionId%></td>
   </tr>
   <tr>
 ...
 %><BR> <tr><BR>  <tdalign="left"><%= name%></td><BR>  <tdalign="left"><%=session.getAttribute(name)%></td>
   </tr>
 <%
  }
 %>
